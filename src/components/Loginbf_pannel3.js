        ...
        <form>
          ...
          <div className={`${styles.row} ${styles.addfileRow}`}>
            ...
            <div className={styles.addfileCol}>
              <input type="file" id="addfile1" className="addfile1" style={{display:"none"}} />
              <button className={styles.addfileBtn1}>
                <img src="img/addfile_camera.png" alt="" />
              </button>
              <input type="file" id="addfile2" className="addfile2" style={{display:"none"}} />
              <button className={styles.addfileBtn2}>
                <img src="img/addfile_camera.png" alt="" />
              </button>
              <input type="file" id="addfile3" className="addfile3" style={{display:"none"}} />
              <button className={styles.addfileBtn3}>
                <img src="img/addfile_camera.png" alt="" />
              </button>
